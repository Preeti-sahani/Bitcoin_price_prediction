# -*- coding: utf-8 -*-
"""
Created on Mon Jan 24 16:53:05 2022
...
st.image("app using streamlit/data/sal.jpg",width = 800)
...
if nav == "Home":
    ...
    if graph == "Non-Interactive":
        ...
        plt.tight_layout()
        st.pyplot()
        st.set_option('deprecation.showPyplotGlobalUse', False)    # for not showing any pyplot error
